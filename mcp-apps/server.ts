...
const APP_DEFINITIONS: AppDefinition[] = [
  {
    ...
    actions: [
      { label: 'Search contacts', tool: 'search_contacts', arguments: { query: '{{query}}' } },
      { label: 'Save contact', tool: 'upsert_contact', arguments: { email: '{{email}}', phone: '{{phone}}' }, requiresConfirmation: true },
      { label: 'Add note', tool: 'create_contact_note', arguments: { contactId: '{{contactId}}', body: '{{note}}' }, requiresConfirmation: true },
      { label: 'Send SMS', tool: 'send_sms', arguments: { contactId: '{{contactId}}', message: '{{message}}' }, requiresConfirmation: true },
    ],
  ...
  },
  {
    ...
    actions: [
      { label: 'Find uncontacted leads', tool: 'find_uncontacted_form_leads' },
      { label: 'Upsert contact', tool: 'upsert_contact', arguments: { email: '{{email}}', phone: '{{phone}}' }, requiresConfirmation: true },
      { label: 'Create opportunity', tool: 'create_opportunity', arguments: { contactId: '{{contactId}}', title: '{{intent}}' }, requiresConfirmation: true },
      { label: 'Enroll workflow', tool: 'add_contact_to_workflow', arguments: { contactId: '{{contactId}}', workflowId: '{{workflowId}}' }, requiresConfirmation: true },
    ],
  ...
  },
  {
    ...
    actions: [
      { label: 'Search conversations', tool: 'search_conversations', arguments: { query: '{{query}}' } },
      { label: 'Send SMS', tool: 'send_sms', arguments: { contactId: '{{contactId}}', message: '{{message}}' }, requiresConfirmation: true },
      { label: 'Send email', tool: 'send_email', arguments: { contactId: '{{contactId}}', subject: '{{subject}}', body: '{{message}}' }, requiresConfirmation: true },
    ],
  ...
  },
  {
    ...
    actions: [
      { label: 'Refresh opportunities', tool: 'search_opportunities', arguments: { pipelineId: '{{pipelineId}}' } },
      { label: 'Move stage', tool: 'update_opportunity_status', arguments: { opportunityId: '{{opportunityId}}', status: '{{status}}' }, requiresConfirmation: true },
      { label: 'Create next task', tool: 'create_contact_task', arguments: { contactId: '{{contactId}}', title: '{{nextStep}}' }, requiresConfirmation: true },
    ],
  ...
  },
  {
    ...
    actions: [
      { label: 'Find free slots', tool: 'get_free_slots', arguments: { calendarId: '{{calendarId}}', startDate: '{{startDate}}' } },
      { label: 'Book appointment', tool: 'create_appointment', arguments: { contactId: '{{contactId}}', calendarId: '{{calendarId}}', startTime: '{{slot}}' }, requiresConfirmation: true },
      { label: 'Reschedule appointment', tool: 'update_appointment', arguments: { appointmentId: '{{appointmentId}}', startTime: '{{slot}}' }, requiresConfirmation: true },
    ],
  ...
  },
  {
    ...
    actions: [
      { label: 'List campaigns', tool: 'get_campaigns' },
      { label: 'List workflows', tool: 'ghl_get_workflows' },
      { label: 'Add to campaign', tool: 'add_contact_to_campaign', arguments: { contactId: '{{contactId}}', campaignId: '{{campaignId}}' }, requiresConfirmation: true },
      { label: 'Trigger workflow', tool: 'ghl_trigger_workflow', arguments: { contactId: '{{contactId}}', workflowId: '{{workflowId}}' }, requiresConfirmation: true },
    ],
  ...
  },
  {
    ...
    actions: [
      { label: 'Refresh reviews', tool: 'get_reviews' },
      { label: 'Reply to review', tool: 'reply_to_review', arguments: { reviewId: '{{reviewId}}', reply: '{{reply}}' }, requiresConfirmation: true },
      { label: 'Send review request', tool: 'send_review_request', arguments: { contactId: '{{contactId}}', message: '{{requestMessage}}' }, requiresConfirmation: true },
    ],
  ...
  },
  {
    ...
    actions: [
      { label: 'Get ad reports', tool: 'get_ad_reports', arguments: { startDate: '{{startDate}}', endDate: '{{endDate}}' } },
      { label: 'Get attribution report', tool: 'get_attribution_report', arguments: { startDate: '{{startDate}}', endDate: '{{endDate}}' } },
      { label: 'Pause campaign', tool: 'official_ad_manager_fb_pause_campaign', arguments: { campaignId: '{{campaignId}}' }, requiresConfirmation: true },
    ],
  ...
  },
  {
    ...
    actions: [
      { label: 'List invoices', tool: 'list_invoices' },
      { label: 'Create invoice', tool: 'create_invoice', arguments: { contactId: '{{contactId}}', amount: '{{amount}}' }, requiresConfirmation: true },
      { label: 'Send invoice', tool: 'send_invoice', arguments: { invoiceId: '{{invoiceId}}' }, requiresConfirmation: true },
      { label: 'Record payment', tool: 'record_order_payment', arguments: { orderId: '{{orderId}}', amount: '{{amount}}' }, requiresConfirmation: true },
    ],
  ...
  },
  {
    ...
    actions: [
      { label: 'Search locations', tool: 'search_locations' },
      { label: 'Search users', tool: 'search_users', arguments: { email: '{{userEmail}}' } },
      { label: 'Push snapshot', tool: 'push_snapshot_to_subaccounts', arguments: { snapshotId: '{{snapshotId}}', locationIds: ['{{locationId}}'] }, requiresConfirmation: true },
    ],
